...
function draw() {
 background(0);
  ...
  //se a flecha estiver tocando o objeto 
  ...
  var balloon_color = Math.round(random(1,4));
  ...
  balloonGroups.add(balloon);

  if(balloonGroups.isTouching(bow)){
    balloonGroups.destroyEach();
  }
